...
export const projects: Project[] = [
  {
    ...
    description: "A SwiftUI iOS app for browsing Pokemon and berry data from the public PokeAPI.",
    longDescription:
    ...
    links: [
      ...
      { label: "Video", url: "https://hosted-video-url-placeholder.com/pokemon-ios-demo", placeholder: true }
    ],
    featured: true
  }
];
...
export const engineeringNotes: EngineeringNote[] = [
  {
    ...
    problem: "Small API ambiguities quickly become frontend conditionals, support issues, and unclear product behavior.",
    investigation: "Trace request shape, validation rules, response states, error semantics, and how mobile/web clients consume them.",
    solution: "Prefer explicit DTOs, consistent response contracts, and API states that describe what the product needs the user to understand.",
  ...
  },
  {
    ...
    summary: "Building login flows that balance reliability, delivery constraints, rate limits, and user feedback.",
    problem: "OTP flows fail in ways that look simple to users but involve delivery providers, expiration, retries, and abuse controls.",
    investigation: "Review code generation, storage, provider responses, retry windows, expiration behavior, and frontend copy for failed attempts.",
    solution: "Model the flow as states: requested, delivered, expired, verified, failed, and rate-limited, then make each state observable.",
  ...
  },
  {
    ...
    theme: "Coordination",
    summary: "Reducing integration surprises by making API expectations explicit before they become runtime bugs.",
    problem: "A backend can be technically correct while still surprising the client through nullability, naming, sorting, or missing metadata.",
    investigation: "Compare DTOs, client models, fixture data, edge responses, and the UI states that depend on them.",
  ...
  },
  {
    ...
    theme: "Cloud",
    summary: "A practical deployment path using Elastic Beanstalk, RDS, Route 53, ACM, and environment-aware configuration.",
    problem: "Deployment bugs often hide in configuration, DNS, certificates, environment variables, or database connectivity.",
    investigation: "Inspect app health, logs, security groups, certificate status, DNS propagation, and runtime environment values.",
    solution: "Treat deployment as a system: app runtime, database, network boundaries, secrets, domains, certificates, and rollback paths.",
  ...
  },
  {
    ...
    theme: "Delivery",
    summary: "Automating checks and deployments so correctness is reinforced before changes reach production.",
    problem: "Manual deployment habits make releases fragile and hard to reason about under pressure.",
    investigation: "Identify build steps, environment secrets, test commands, deployment triggers, and failure reporting.",
  ...
  },
  {
    ...
    theme: "Integrations",
    summary: "Working with OpenAI, Twilio, and email services as real dependencies with latency, failure modes, and cost.",
    problem: "Provider APIs introduce non-local behavior: retries, rate limits, schema changes, and confusing partial failures.",
    investigation: "Read provider responses closely, isolate adapters, log meaningful context, and understand what the product should do when providers fail.",
    solution: "Wrap provider calls behind small services, normalize errors, and keep business logic separate from SDK details.",
  ...
  },
  {
    ...
    theme: "Debugging",
    summary: "Following a bug across UI state, network calls, backend logic, persistence, and deployment configuration.",
    problem: "The visible bug is often several steps away from the real cause.",
    investigation: "Reproduce the behavior, inspect request timelines, compare expected and actual payloads, and trace data through each boundary.",
    solution: "Debug from symptoms toward causes, preserving evidence at each layer instead of guessing from the first failing screen.",
  ...
  },
  {
    ...
    theme: "Architecture",
    summary: "Thinking through content systems where attribution, remix lineage, metadata, and personalization affect product trust.",
    problem: "Content feeds become hard to reason about when personalization, derived content, attribution, and history all interact.",
    investigation: "Map entities, ownership, snapshots, metadata, remix relationships, ranking inputs, and user-visible explanations.",
  ...
  },
  {
    ...
    problem: "Concurrent behavior often fails only under timing pressure, which makes it easy to miss in happy-path testing.",
    investigation: "Look for shared resources, non-idempotent operations, ordering assumptions, and places where retries can duplicate effects.",
    solution: "Make state transitions explicit, prefer idempotent operations where possible, and test edge timing scenarios intentionally.",
  ...
  },
  {
    ...
    theme: "Workflow",
    summary: "Using AI naturally for learning, debugging, architecture exploration, and communication without outsourcing judgment.",
    problem: "AI can accelerate exploration, but only if the engineer keeps responsibility for correctness and product fit.",
    investigation: "Use AI to compare approaches, generate hypotheses, explain unfamiliar code, and pressure-test architecture decisions.",
    solution: "Treat AI as a thinking tool: useful for speed and breadth, but always grounded by tests, docs, logs, and code review.",
...
export const navCards = [
  {
    ...
    title: "About / Contact",
    eyebrow: "Identity",
    description: "Backend focus, iOS experience, education, contact links, and the way Thomas thinks through systems."
  },
  {
    key: "projects" as const,
    title: "Projects",
    eyebrow: "Work",
    description: "A project structure led by a SwiftUI Pokemon app and ready for deeper case studies."
  },
  {
    key: "notes" as const,
    title: "Engineering Notes",
    eyebrow: "Thinking",
    description: "Short case-study notes showing practical ownership across APIs, cloud, integrations, and debugging."
  }
];
